 ...
 * @author PC
 */
public class ExcluirProdutoSessao extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExcluirProdutoSessao</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExcluirProdutoSessao at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
            try {
