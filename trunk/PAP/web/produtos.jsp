...
//                   }
                    ...
                    <tr>
                        ...
                        <td><a href="#" onclick="refreshPage('produtos2','inserir_produto_sessao.do?div=produtos_orcamento&id=<%=p.getId()%>&qnt=0'); refreshPage('valor','valor_total.jsp');"><img src="imagens/add.png"/></a></td>
                    </tr>
